...
const aiToolCategories: AIToolCategory[] = [
  ...
  },
  {
    ...
    icon: FileText,
    tools: [
      { id: 'ai-blog-writer', title: 'AI Blog Writer', description: 'Generate SEO-optimized blog posts and articles', url: '/tools/content-creation/ai-blog-writer', status: 'coming-soon' },
  ...
  },
  {
    ...
    icon: Palette,
    tools: [
      { id: 'ai-image-generator', title: 'AI Image Generator', description: 'Create custom images from text prompts', url: '/tools/visual-content/ai-image-generator', status: 'coming-soon' },
